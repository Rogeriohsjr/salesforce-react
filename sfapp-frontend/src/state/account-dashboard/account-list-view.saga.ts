...
import { IAccountBaseDTO, IDeleteAccountBaseDTO } from '../../api/account-api/dtos/account-response-dto';
import ISalesforceErrorDTO from '../../api/services/dtos/salesforce-error-dto';
import { APIResponseType } from '../../api/services/api-response-type';
...
export function* deleteAccountSaga(action: IPayloadActionType<string>) {
  ...
  const result: APIResponseType<IDeleteAccountBaseDTO, ISalesforceErrorDTO> = yield call(AccountAPI.deleteAccount, accountId);
